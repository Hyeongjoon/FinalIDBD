...
public class DBHelper  extends SQLiteOpenHelper {
    ...
    // Contacts table name
    private static final String TABLE_GR_LIST ="GR_LIST";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String create_gr_list = "CREATE TABLE " + TABLE_GR_LIST + "("+GR_ID +" INTEGER UNSIGNED PRIMARY KEY,"+WRITER+" INTEGER UNSIGNED, content TEXT);";
